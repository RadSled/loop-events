  ...
  return (
    <aside className="le-sidebar">
      <div className="le-sb-top">
        ...
        {props.currentSiteName ? (
          props.isCurrentSiteConnected ? (
            <div
              className={`le-sbSiteMeta is-connected ${siteTruncated ? "is-truncated" : ""}`}
            ...
            <button
              type="button"
              className={`le-sbSiteMeta le-sbSiteMetaButton is-disconnected ${siteTruncated ? "is-truncated" : ""}`}
              title={`Connected site: ${props.currentSiteName}`}
              aria-label={`Connected site: ${props.currentSiteName}`}
